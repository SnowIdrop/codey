  ...
  if (!window.__codeyInvokeApi) {
    ...
    let previewConfig: Config = {
      ...
      workflow: {
        ...
        retentionDays: 30,
        roles: {
          preflight: { enabled: true, model: "gpt-5.6-sol", reasoningEffort: "high" },
          scout: { enabled: true, model: "gpt-5.6-sol", reasoningEffort: "medium" },
          builder: { enabled: true, model: "provider-fast-coder", reasoningEffort: "high" },
          validator: { enabled: true, model: "gpt-5.6-sol", reasoningEffort: "medium" },
          reviewer: { enabled: true, model: "gpt-5.6-sol", reasoningEffort: "high" },
          expert: { enabled: true, model: "gpt-5.6-terra", reasoningEffort: "high" },
        },
      },
